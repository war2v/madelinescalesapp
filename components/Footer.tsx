            ...
            <div className=" mx-auto px-6 md:px-12">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
                    ...
                    <p className="text-slate-400 font-medium leading-relaxed mb-6 max-w-sm">
                        A legacy of 24 years of service. Daughter of history. Advocate for all. Leading with heart and standing firm for Murfreesboro.
                    </p>
                    </div>

                    <div>
                    <h4 className="text-[#FFB800] font-black uppercase tracking-widest mb-6">Contact</h4>
                    <ul className="space-y-4">
                        ...
                        <span>P.O. Box 1234<br/>Murfreesboro, TN 37133</span>
                        </li>
                    </ul>
                    </div>

                    <div>
                    <h4 className="text-[#FFB800] font-black uppercase tracking-widest mb-6">Quick Links</h4>
                       <ul className="space-y-3">
                        {navLinks.map(link => (
                        <li key={link.name}>
                            <a href={link.href} className="text-slate-300 hover:text-white uppercase font-bold text-sm tracking-wider transition-colors">
                            {link.name}
                            </a>
                        </li>
                        ))}
                    ...
                    <div>
                    <h4 className="text-[#FFB800] font-black uppercase tracking-widest mb-6">Share the Vision</h4>
                    <div className="bg-white p-4 inline-block rounded-xl shadow-lg transform rotate-2 hover:rotate-0 transition-transform">
                        <QRCode value="https://scalesforcouncil.com" size={120} level="H" />
                        <p className="text-[#0B0F19] text-xs font-black text-center mt-2 uppercase">Scan to Join</p>
                    </div>
                    </div>
                </div>
