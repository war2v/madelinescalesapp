...
export const Legacy = () => {
  return (
    <section
      id="legacy"
      className="py-24 md:py-32 bg-slate-100 overflow-hidden"
    >
      <div className="mx-auto px-6 md:px-12">
        <div className="text-center mb-20">
          <h2 className="text-[#0B0F19] text-5xl md:text-7xl font-black uppercase tracking-tighter leading-none mb-6">
            A Legacy Built <br />
            On <span className="text-[#E53935]">History.</span>
          </h2>
          <p className="text-xl text-slate-600 font-bold max-w-3xl mx-auto">
            Public service runs deep in our veins. From groundbreaking firsts to
            building the foundation of modern Murfreesboro, this is more than a
            campaign—it is a continuation of a family's promise to its people.
          </p>
        </div>
        ...
        <div className="relative max-w-5xl mx-auto">
          ...
          <div className="relative flex flex-col md:flex-row items-center justify-between mb-16 md:mb-24 group">
            <div className="hidden md:block w-5/12 text-right pr-8">
              <h3 className="text-3xl font-black text-[#0B0F19] uppercase tracking-tighter">
                Breaking Barriers
              </h3>
          ...
          <div className="relative flex flex-col md:flex-row items-center justify-between mb-16 md:mb-24 group">
            <div className="w-full md:w-5/12 pl-12 md:pl-0 md:pr-8 text-left md:text-right mb-4 md:mb-0 order-2 md:order-1">
              <div className="bg-[#0B0F19] text-white p-6 shadow-xl border-t-4 border-[#E53935]">
                <UserCheck
                  className="text-[#E53935] mb-4 md:ml-auto"
                  size={32}
                />
                <h3 className="md:hidden text-2xl font-black text-white uppercase tracking-tighter mb-2">
                  A Mother's Impact
                </h3>
                <p className="md:hidden text-slate-400 font-medium mb-4">
                  Daughter of the first Black female council woman, showing that
          ...
          <div className="relative flex flex-col md:flex-row items-center justify-between group">
            <div className="hidden md:block w-5/12 text-right pr-8">
              ...
              <p className="text-slate-600 font-medium mt-2">
                A family legacy set in stone. The community honored this
                generational impact by naming a school after the family—a daily
                reminder of our commitment to education and the future.
              </p>
            </div>
            ...
            <div className="w-full md:w-5/12 pl-12 md:pl-8">
              <div className="bg-white p-6 shadow-xl border-t-4 border-[#0B0F19]">
                ...
                <p className="md:hidden text-slate-600 font-medium">
                  A family legacy set in stone. The community honored this
                  generational impact by naming a school after the family.
                </p>
              </div>
            </div>
          </div>
