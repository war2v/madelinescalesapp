        ...
        <div className=" mx-auto px-6 md:px-12">
          <div className="flex flex-col lg:flex-row gap-16 items-center">
            <div className="w-full lg:w-1/2 relative">
              ...
              <img src={"/images/scales.jpg"} alt="Candidate Portrait" className="relative z-10 w-full h-auto grayscale hover:grayscale-0 transition-all duration-700 object-cover shadow-2xl" />
